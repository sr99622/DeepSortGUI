...
public:
    DarknetModel(QMainWindow *parent, QObject *darknet);
...
public:
    Darknet(QMainWindow *parent, const QString& baseKey);
    ...
    QString baseKey;
    QString cfgKey() const;
    QString weightsKey() const;
    QString namesKey() const;
    QString thresholdKey() const;
