...
CudaExceptionHandler::CudaExceptionHandler()
{
...
/*
CudaException::CudaException(const string& arg) : runtime_error(arg)
{

}
*/

QString CudaExceptionHandler::getErrorText(const NppStatus& status)
{
    QString result;
    switch (status) {
